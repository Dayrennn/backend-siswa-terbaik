...
export const update = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Data berhasil dirubah', data: updatedUser });
    } catch (error) {
        res.status(400).json({ message: error.message });
    }
};
...
export const getUsers = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Berhasil mengambil data users', data: users });
    } catch (error) {
        res.status(400).json({ message: error.message });
    }
};
...
export const getUserById = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: 'Berhasil mengambil data user by id', data: user });
    } catch (error) {
        res.status(400).json({ message: error.message });
    }
};
