...
export const createKelas = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Data kelas berhasil ditambah", data: addedKelas });
  } catch (error) {
...
export const modifyKelas = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Data berhasil diubah", data: updatedKelas });
  } catch (error) {
    res.status(400).json({ message: error.message });
  }
};
...
export const getKelasById = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Berhasil Mengambil Data Kelas", data: kelas });
  } catch (error) {
    res.status(400).json({ message: error.message });
  }
};
...
export const removeKelas = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Data berhasil dihapus", data: deletedKelas });
  } catch (error) {
    res.status(400).json({ message: error.message });
  }
};
